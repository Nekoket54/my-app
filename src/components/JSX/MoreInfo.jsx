    ...
    return(
        <section className="moreInfo">  
            <div className="moreInfo-sensations container">
                ...
                <h2 className="moreInfo-sensations-name name">{data.feels_like}℃</h2>
            ...
            <div className="moreInfo-range container">
                ...
                <h2 className="moreInfo-range-name name">{data.temp_min}℃</h2>
                <p className="moreInfo-range-text text">Max ℃</p>
                <h2 className="moreInfo-range-name name">{data.temp_max}℃</h2>
            </div>
            <div className="moreInfo-humidity container">
                <p className="moreInfo-humidity-text text">Humidity</p>
                <h2 className="moreInfo-humidity-name name">{data.humidity}%</h2>
            ...
            <div className="moreInfo-pressure container">
                ...
                <h2 className="moreInfo-pressure-name name">{data.pressure} Pa</h2>
            ...
            <div className="moreInfo-windSpeed container">
                ...
                <h2 className="moreInfo-windSpeed-name name">{data.wind_speed} m/s</h2>
